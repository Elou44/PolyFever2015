...
public class Affichage {
	...
	/**
	 * <p>
	 * Cet Méthode instancie un objet du type {@link DessinMenu}
	 * et appelle la méthode d'initialisation de cet objet.
	 * </p>
	 * @param p
	 * 		référence vers un objet de type {@link PolyFever} (classe créant le contexte OpenGL) 
	 * 
	 * @author Elouarn Lainé
	 */
	...
	/**
	 * <p>
	 * Cet Méthode instancie un objet du type {@link DessinJeu}
	 * et appelle la méthode d'initialisation de cet objet.
	 * </p>
	 * @param p
	 * 		référence vers l'objet de type {@link PolyFever} (classe créant le contexte OpenGL) 
	 * @param partie
	 * 		référence vers l'objet de type {@link Partie} (Classe principale du moteur de jeu)
	 * @author Elouarn Lainé
	 */
